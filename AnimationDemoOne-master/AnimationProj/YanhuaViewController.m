...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    [YQAnimationLayer createAnimationLayerWithString:@"ZW  LOVE  LFJ" andRect: CGRectMake(0, 100, self.view.frame.size.width, self.view.frame.size.width) andView:self.view andFont:[UIFont boldSystemFontOfSize:40] andStrokeColor:[UIColor cyanColor]];

//    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
//        
//     [YQAnimationLayer createAnimationLayerWithString2:@"文" andRect: CGRectMake(0, 200, self.view.frame.size.width, self.view.frame.size.width) andView:self.view andFont:[UIFont boldSystemFontOfSize:40] andStrokeColor:[UIColor cyanColor]];
//        
//        
//    });
...
- (void)SetupEmitter{
    ...
    rocket.lifetime			= 3.02;	// we cannot set the birthrate < 1.0 for the burst
  ...
  /*  @property float redRange;
    ...
    */
    ...
    self.fireworksEmitter =fireworksEmitter;
